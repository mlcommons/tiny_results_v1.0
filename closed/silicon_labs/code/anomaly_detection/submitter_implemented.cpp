...
void th_final_initialize(void) {
  ...
  // TensorFlow initialization handled by sl_system_init()

  // Obtain pointers to input and output tensors
  input_tensor = sl_tflite_micro_get_input_tensor();
  output_tensor = sl_tflite_micro_get_output_tensor();
}
...
void th_serialport_initialize(void) {
  ...
  EUSART_BaudrateSet(SL_IOSTREAM_EUSART_VCOM_PERIPHERAL, 0, 9600);
#else
