...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='BUILD_MODEL_NE16_QUANT/vww_96.json',
    ...
    if os.path.isfile(file_name):
        ...
        dat = np.fromfile(file_name, dtype=np.uint8).reshape([96, 96, 3]).astype(np.float32) / 255
