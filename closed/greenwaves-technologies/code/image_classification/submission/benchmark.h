...
#include "pretrainedResnetInfo.h"
#include "pretrainedResnetKernels.h"
...
// data buffer
typedef unsigned char uart_input_type;
...
void preprocessing(unsigned char * ptr_src, input_type * ptr_dst)
{
    // ptr_src have elements saved as uint8: ptr_src range [0:255] --> float range [0:255]
    // with quantization scheme for tflite, i.e. r = S*(q-Z) --> S=1 Z=0
